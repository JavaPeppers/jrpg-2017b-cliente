...
public class ActualizarComercio extends ComandosEscucha {
    /**
     * Cantidad de items máximos que puede tener un personaje.
     */
    public static final int ITEMS_MAXIMOS = 9;
